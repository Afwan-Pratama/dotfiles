...
Theme.border_normal = color["Surface"]
...
Theme.menu_bg_focus = color["Surface"]
Theme.menu_fg_focus = color["White"]
Theme.menu_border_color = color["Surface"]
...
Theme.tooltip_border_color = color["Surface"]
Theme.tooltip_bg = color["Black"]
Theme.tooltip_fg = color["Yellow"]
